...
public class TradeAppServlet extends HttpServlet {
    ...
    public void performTask(HttpServletRequest req, HttpServletResponse resp)
        ...
        XTraceContext.startTrace("TradeAppServlet", "Starting" , "sample");
        ServletContext ctx = getServletConfig().getServletContext();
	XTraceContext.logEvent("Front End Servlet", "operationA");
	String xtraceMD = (XTraceContext.getThreadContext().pack()).toString();
        req.setAttribute("Xtrace",xtraceMD);
	XTraceContext.logEvent("Front End Servlet", "operationB");
        if (action == null) {
        ...
        if (action.equals("quotes")) {
            ...
            tsAction.doPortfolio(ctx, req, resp, userID, "Portfolio as of "
                    + new java.util.Date());
	    XTraceContext.setThreadContext(XTraceMetadata.createFromString((String)req.getAttribute("Xtrace")));
	    XTraceContext.logEvent("Front End", "ReceivedBLMessage");
